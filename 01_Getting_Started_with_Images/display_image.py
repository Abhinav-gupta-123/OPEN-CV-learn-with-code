...
cb_img = cv2.imread(r"C:\Users\abhin\Desktop\computer_vision\opencv-python-free-course-code\01_Getting_Started_with_Images\checkerboard_color.png")
coke_img = cv2.imread(r"C:\Users\abhin\Desktop\computer_vision\opencv-python-free-course-code\01_Getting_Started_with_Images\coca-cola-logo.png")
